...
/* Newer SDK releases route register addresses through this macro for parts with
   TrustZone; the RT1052 has no secure alias and this project’s fsl_common.h
   predates the macro, so it is the identity here. */
