...
/* from a newer fsl_common than this project's (2.4.0): the secure alias of a
   peripheral address - on a part without TrustZone the address itself */
...
#define FSL_EDMA_DRIVER_VERSION (MAKE_VERSION(2, 4, 5)) /*!< Version 2.4.5. */
/*! @} */
