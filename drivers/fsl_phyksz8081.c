...
/* the EVKB's KSZ8081RNB gets its 50 MHz RMII reference clock from the i.MX RT: the
   PHY must be told (PHY Control 2, bit 7), or it stays in 25 MHz mode and never links */
#ifndef FSL_FEATURE_PHYKSZ8081_USE_RMII50M_MODE
