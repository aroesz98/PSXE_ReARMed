...
int32_t psx_load_expansion(psx_t *, const char *);
int32_t psx_load_bios(psx_t *, const char *);
...
float psx_get_display_aspect(psx_t *);
uint32_t *psx_take_screenshot(psx_t *);
int32_t psx_swap_disc(psx_t *, const char *);
