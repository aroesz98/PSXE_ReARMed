...
static int32_t g_config_instance_used = 0;
...
void psxe_cfg_load(psxe_config_t *cfg, int32_t argc, const char *argv[])
{
    log_set_level(LOG_INFO);

    int32_t use_args = 0;
    int32_t version = 0;
    int32_t help_model = 0;
    int32_t help_region = 0;
    int32_t log_level = 0;
    int32_t quiet = 0;
    int32_t console_source = 0;
    int32_t scale = 0;
