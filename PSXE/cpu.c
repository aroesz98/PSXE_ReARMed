...
static inline void psx_cpu_i_srl(psx_cpu_t *);
static inline void psx_cpu_i_sra(psx_cpu_t *);
static inline void psx_cpu_i_sllv(psx_cpu_t *);
static inline void psx_cpu_i_srlv(psx_cpu_t *);
static inline void psx_cpu_i_srav(psx_cpu_t *);
static inline void psx_cpu_i_jr(psx_cpu_t *);
static inline void psx_cpu_i_jalr(psx_cpu_t *);
static inline void psx_cpu_i_syscall(psx_cpu_t *);
static inline void psx_cpu_i_break(psx_cpu_t *);
static inline void psx_cpu_i_mfhi(psx_cpu_t *);
static inline void psx_cpu_i_mthi(psx_cpu_t *);
static inline void psx_cpu_i_mflo(psx_cpu_t *);
static inline void psx_cpu_i_mtlo(psx_cpu_t *);
static inline void psx_cpu_i_mult(psx_cpu_t *);
static inline void psx_cpu_i_multu(psx_cpu_t *);
static inline void psx_cpu_i_div(psx_cpu_t *);
static inline void psx_cpu_i_divu(psx_cpu_t *);
static inline void psx_cpu_i_add(psx_cpu_t *);
static inline void psx_cpu_i_addu(psx_cpu_t *);
static inline void psx_cpu_i_sub(psx_cpu_t *);
static inline void psx_cpu_i_subu(psx_cpu_t *);
static inline void psx_cpu_i_and(psx_cpu_t *);
static inline void psx_cpu_i_or(psx_cpu_t *);
static inline void psx_cpu_i_xor(psx_cpu_t *);
static inline void psx_cpu_i_nor(psx_cpu_t *);
static inline void psx_cpu_i_slt(psx_cpu_t *);
static inline void psx_cpu_i_sltu(psx_cpu_t *);
static inline void psx_cpu_i_bltz(psx_cpu_t *);
static inline void psx_cpu_i_bgez(psx_cpu_t *);
static inline void psx_cpu_i_bltzal(psx_cpu_t *);
static inline void psx_cpu_i_bgezal(psx_cpu_t *);
static inline void psx_cpu_i_j(psx_cpu_t *);
static inline void psx_cpu_i_jal(psx_cpu_t *);
static inline void psx_cpu_i_beq(psx_cpu_t *);
static inline void psx_cpu_i_bne(psx_cpu_t *);
static inline void psx_cpu_i_blez(psx_cpu_t *);
static inline void psx_cpu_i_bgtz(psx_cpu_t *);
static inline void psx_cpu_i_addi(psx_cpu_t *);
static inline void psx_cpu_i_addiu(psx_cpu_t *);
static inline void psx_cpu_i_slti(psx_cpu_t *);
static inline void psx_cpu_i_sltiu(psx_cpu_t *);
static inline void psx_cpu_i_andi(psx_cpu_t *);
static inline void psx_cpu_i_ori(psx_cpu_t *);
static inline void psx_cpu_i_xori(psx_cpu_t *);
static inline void psx_cpu_i_lui(psx_cpu_t *);
static inline void psx_cpu_i_mfc0(psx_cpu_t *);
static inline void psx_cpu_i_mtc0(psx_cpu_t *);
static inline void psx_cpu_i_rfe(psx_cpu_t *);
static inline void psx_cpu_i_mfc2(psx_cpu_t *);
static inline void psx_cpu_i_cfc2(psx_cpu_t *);
static inline void psx_cpu_i_mtc2(psx_cpu_t *);
static inline void psx_cpu_i_ctc2(psx_cpu_t *);
static inline void psx_cpu_i_lb(psx_cpu_t *);
static inline void psx_cpu_i_lh(psx_cpu_t *);
static inline void psx_cpu_i_lwl(psx_cpu_t *);
static inline void psx_cpu_i_lw(psx_cpu_t *);
static inline void psx_cpu_i_lbu(psx_cpu_t *);
static inline void psx_cpu_i_lhu(psx_cpu_t *);
static inline void psx_cpu_i_lwr(psx_cpu_t *);
static inline void psx_cpu_i_sb(psx_cpu_t *);
static inline void psx_cpu_i_sh(psx_cpu_t *);
static inline void psx_cpu_i_swl(psx_cpu_t *);
static inline void psx_cpu_i_sw(psx_cpu_t *);
static inline void psx_cpu_i_swr(psx_cpu_t *);
static inline void psx_cpu_i_lwc0(psx_cpu_t *);
static inline void psx_cpu_i_lwc1(psx_cpu_t *);
static inline void psx_cpu_i_lwc2(psx_cpu_t *);
static inline void psx_cpu_i_lwc3(psx_cpu_t *);
static inline void psx_cpu_i_swc0(psx_cpu_t *);
static inline void psx_cpu_i_swc1(psx_cpu_t *);
static inline void psx_cpu_i_swc2(psx_cpu_t *);
static inline void psx_cpu_i_swc3(psx_cpu_t *);
...
void psx_cpu_force_reset_singleton(void)
{
...
void psx_cpu_save_state(psx_cpu_t *cpu, FIL *file)
{
    UINT bytesWritten;
    f_write(file, (char *)cpu, sizeof(*cpu) - sizeof(psx_bus_t *), &bytesWritten);
}

void psx_cpu_load_state(psx_cpu_t *cpu, FIL *file)
{
    UINT bytesRead;
    FRESULT res = f_read(file, (char *)cpu, sizeof(*cpu) - sizeof(psx_bus_t *), &bytesRead);
    if (res != FR_OK || bytesRead != (sizeof(*cpu) - sizeof(psx_bus_t *)))
    {
        /* Error reading CPU state - could log this */
        /* For now, we'll just return without exit() since we're in embedded environment */
        return;
    }
}
...
void __attribute__((section(".ramfunc.$SRAM_ITC"))) psx_cpu_cycle(psx_cpu_t *cpu)
{
    ...
    if (!cyc)
    {
        PRINTF("psxe: Illegal instruction %08x at %08x (next=%08x, saved=%08x)\r\n",
               (uint32_t)cpu->opcode, (uint32_t)cpu->pc,
               (uint32_t)cpu->next_pc, (uint32_t)cpu->saved_pc);
...
{
    log_fatal("%08x: Illegal instruction %08x", (uint32_t)(cpu->pc - 8), (uint32_t)cpu->opcode);
...
static inline void psx_cpu_i_lwl(psx_cpu_t *cpu)
{
    ...
    // PRINTF("lwl rt=%u s=%08lx t=%08lx addr=%08lx load=%08lx (%08lx) shift=%u mask=%08lx value=%08lx\n",
...
static inline void psx_cpu_i_lwr(psx_cpu_t *cpu)
{
    ...
    // PRINTF("lwr rt=%u s=%08lx t=%08lx addr=%08lx load=%08lx (%08lx) shift=%u mask=%08lx value=%08lx\n",
    //     rt, s, t, addr, load, addr & 0xfffffffc, shift, mask, value
    // );
}
...
static inline void psx_cpu_i_sub(psx_cpu_t *cpu)
{
    ...
    int32_t o = __builtin_ssub_overflow((int32_t)s, (int32_t)t, (int *)&r);
...
{
    cpu->cop2_dr.ir[1] = ((cpu->cop2_dr.irgb >> 11) & 0x1f) * 0x80; // RGB565: Red bits 15-11
    cpu->cop2_dr.ir[2] = ((cpu->cop2_dr.irgb >> 5) & 0x3f) * 0x40;  // RGB565: Green bits 10-5 (6 bits, so scale by 0x40)
    cpu->cop2_dr.ir[3] = ((cpu->cop2_dr.irgb >> 0) & 0x1f) * 0x80;  // RGB565: Blue bits 4-0
}

static inline void gte_handle_irgb_read(psx_cpu_t *cpu)
{
    int32_t r = CLAMP(cpu->cop2_dr.ir[1] >> 7, 0x00, 0x1f); // RGB565: Red 5 bits
    int32_t g = CLAMP(cpu->cop2_dr.ir[2] >> 6, 0x00, 0x3f); // RGB565: Green 6 bits
    int32_t b = CLAMP(cpu->cop2_dr.ir[3] >> 7, 0x00, 0x1f); // RGB565: Blue 5 bits

    cpu->cop2_dr.irgb = (r << 11) | (g << 5) | b; // RGB565 format
}
...
static inline void gte_handle_lzcs_write(psx_cpu_t *cpu)
{
    ...
    int32_t b = (cpu->cop2_dr.lzcs >> 31) & 1;
...
static inline int32_t gte_clamp_mac(psx_cpu_t *cpu, int32_t i, int64_t value)
{
    if (i == 3)
        cpu->s_mac3 = value;
...
static inline int32_t clz(uint32_t value)
{
    if (!value)
        return 32;
...
static inline uint32_t gte_divide(psx_cpu_t *cpu, uint16_t n, uint16_t d)
{
    ...
    int32_t shift = clz(d) - 16;

    int32_t r1 = (d << shift) & 0x7fff;
    int32_t r2 = g_psx_gte_unr_table[((r1 + 0x40) >> 7)] + 0x101;
    int32_t r3 = ((0x80 - (r2 * (r1 + 0x8000))) >> 8) & 0x1ffff;
