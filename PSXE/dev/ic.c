...
uint16_t psx_ic_read16(psx_ic_t *ic, uint32_t offset)
{
    ...
    {
    case 0x00:
        result = (ic->stat >> 0) & 0xffff;
        break;
    case 0x02:
        result = (ic->stat >> 16) & 0xffff;
        break;
    case 0x04:
        result = (ic->mask >> 0) & 0xffff;
        break;
    case 0x06:
        result = (ic->mask >> 16) & 0xffff;
        break;
    default:
        log_error("Unhandled 16-bit IC read at offset %08x", offset);
        return 0x0;
    }
    log_debug("IC 16-bit read at offset %08x: %04x", offset, result);
    return result;
...
void psx_ic_write16(psx_ic_t *ic, uint32_t offset, uint16_t value)
{
    ...
    case 0x06:
        ...
        break;
    default:
        log_error("Unhandled 16-bit IC write at offset %08x (%04x)", offset, value);
        return;
    }
