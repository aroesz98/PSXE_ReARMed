...
typedef struct
{
    ...
    int32_t mdec_in_irq_delay;
    int32_t mdec_out_irq_delay;
    int32_t cdrom_irq_delay;
    int32_t spu_irq_delay;
    int32_t gpu_irq_delay;
    int32_t otc_irq_delay;
...
void psx_dma_update(psx_dma_t *, int32_t);
