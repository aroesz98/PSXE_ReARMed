...
void psx_pad_button_press(psx_pad_t *, int32_t, uint32_t);
void psx_pad_button_release(psx_pad_t *, int32_t, uint32_t);
void psx_pad_analog_change(psx_pad_t *, int32_t, uint32_t, uint16_t);
