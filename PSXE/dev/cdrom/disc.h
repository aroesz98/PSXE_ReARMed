...
typedef int32_t (*read_sector_func)(void *, uint32_t, void *);
typedef int32_t (*query_sector_func)(void *, uint32_t);
typedef int32_t (*get_track_number_func)(void *, uint32_t);
typedef int32_t (*get_track_count_func)(void *);
