...
/*
    ...
    Pause (float speed)   010bd93h  010477Ah..011B302h ;/about 5 sectors
    Pause (when paused)    0001df2h  0001d25h..0001f22h
    Stop (single speed)    0d38acah  0c3bc41h..0da554dh
    Stop (float speed)    18a6076h  184476bh..192b306h
...
/*
    7   Speed       (0=Normal speed, 1=float speed)
...
typedef struct
{
    ...
    int32_t region;
    int32_t index;
    int32_t pending_speed_switch_delay;
    int32_t seek_precision;
    int32_t fake_getlocl_data;
    uint8_t ier;
    uint8_t ifr;
    ...
    int32_t data_req;
    psx_queue_t *data;
    psx_queue_t *response;
    psx_queue_t *parameters;
    ...
    int32_t xa_channel;
    int32_t xa_file;
    int32_t xa_remaining_samples;
    int16_t xa_left_h[2];
    int16_t xa_right_h[2];
    int16_t xa_prev_left_sample;
    int16_t xa_prev_right_sample;
    int32_t xa_sample_index;
    int32_t state;
    int32_t prev_state;
    int32_t int1_pending;
    int32_t int2_pending;
    int32_t delay;
